...
def main(argv):
  ...
  try:
    opts, args = getopt.getopt(argv,"hi:o:c:x:l",["ifile=","ofile=","headers=","headershelp=","listfields="])
  ...
  if 'listfields' in locals():
    count = 0
    string = ''
    end = len(table.fields.items())
